...
STATE(SPR_PUNG,1,4,NULL,S_PUNCH2),      /* S_PUNCH1 */
STATE(SPR_PUNG,2,4,A_Punch,S_PUNCH3),   /* S_PUNCH2 */
STATE(SPR_PUNG,3,5,NULL,S_PUNCH4),      /* S_PUNCH3 */
STATE(SPR_PUNG,2,4,NULL,S_PUNCH5),      /* S_PUNCH4 */
...
STATE(SPR_PISG,0,4,NULL,S_PISTOL2),     /* S_PISTOL1 */
STATE(SPR_PISG,1,6,A_FirePistol,S_PISTOL3),     /* S_PISTOL2 */
STATE(SPR_PISG,2,4,NULL,S_PISTOL4),     /* S_PISTOL3 */
...
STATE(SPR_SHTG,0,3,NULL,S_SGUN2),       /* S_SGUN1 */
STATE(SPR_SHTG,0,7,A_FireShotgun,S_SGUN3),      /* S_SGUN2 */
STATE(SPR_SHTG,1,5,NULL,S_SGUN4),       /* S_SGUN3 */
STATE(SPR_SHTG,2,5,NULL,S_SGUN5),       /* S_SGUN4 */
STATE(SPR_SHTG,3,4,NULL,S_SGUN6),       /* S_SGUN5 */
STATE(SPR_SHTG,2,5,NULL,S_SGUN7),       /* S_SGUN6 */
STATE(SPR_SHTG,1,5,NULL,S_SGUN8),       /* S_SGUN7 */
STATE(SPR_SHTG,0,3,NULL,S_SGUN9),       /* S_SGUN8 */
...
STATE(SPR_MISF,32769,4,NULL,S_MISSILEFLASH3),   /* S_MISSILEFLASH2 */
...
STATE(SPR_BLUD,2,8,NULL,S_BLOOD2),      /* S_BLOOD1 */
STATE(SPR_BLUD,1,8,NULL,S_BLOOD3),      /* S_BLOOD2 */
STATE(SPR_BLUD,0,8,NULL,S_NULL),        /* S_BLOOD3 */
STATE(SPR_PUFF,32768,4,NULL,S_PUFF2),   /* S_PUFF1 */
STATE(SPR_PUFF,1,4,NULL,S_PUFF3),       /* S_PUFF2 */
STATE(SPR_PUFF,2,4,NULL,S_PUFF4),       /* S_PUFF3 */
STATE(SPR_PUFF,3,4,NULL,S_NULL),        /* S_PUFF4 */
STATE(SPR_BAL1,32768,4,NULL,S_TBALL2),  /* S_TBALL1 */
STATE(SPR_BAL1,32769,4,NULL,S_TBALL1),  /* S_TBALL2 */
STATE(SPR_BAL1,32770,6,NULL,S_TBALLX2), /* S_TBALLX1 */
STATE(SPR_BAL1,32771,6,NULL,S_TBALLX3), /* S_TBALLX2 */
STATE(SPR_BAL1,32772,6,NULL,S_NULL),    /* S_TBALLX3 */
STATE(SPR_BAL2,32768,4,NULL,S_RBALL2),  /* S_RBALL1 */
STATE(SPR_BAL2,32769,4,NULL,S_RBALL1),  /* S_RBALL2 */
STATE(SPR_BAL2,32770,6,NULL,S_RBALLX2), /* S_RBALLX1 */
STATE(SPR_BAL2,32771,6,NULL,S_RBALLX3), /* S_RBALLX2 */
STATE(SPR_BAL2,32772,6,NULL,S_NULL),    /* S_RBALLX3 */
STATE(SPR_BAL7,32768,4,NULL,S_BRBALL2), /* S_BRBALL1 */
STATE(SPR_BAL7,32769,4,NULL,S_BRBALL1), /* S_BRBALL2 */
STATE(SPR_BAL7,32770,6,NULL,S_BRBALLX2),        /* S_BRBALLX1 */
STATE(SPR_BAL7,32771,6,NULL,S_BRBALLX3),        /* S_BRBALLX2 */
STATE(SPR_BAL7,32772,6,NULL,S_NULL),    /* S_BRBALLX3 */
STATE(SPR_PLSS,32768,6,NULL,S_PLASBALL2),       /* S_PLASBALL */
STATE(SPR_PLSS,32769,6,NULL,S_PLASBALL),        /* S_PLASBALL2 */
STATE(SPR_PLSE,32768,4,NULL,S_PLASEXP2),        /* S_PLASEXP */
STATE(SPR_PLSE,32769,4,NULL,S_PLASEXP3),        /* S_PLASEXP2 */
STATE(SPR_PLSE,32770,4,NULL,S_PLASEXP4),        /* S_PLASEXP3 */
STATE(SPR_PLSE,32771,4,NULL,S_PLASEXP5),        /* S_PLASEXP4 */
STATE(SPR_PLSE,32772,4,NULL,S_NULL),    /* S_PLASEXP5 */
STATE(SPR_MISL,32768,1,NULL,S_ROCKET),  /* S_ROCKET */
STATE(SPR_BFS1,32768,4,NULL,S_BFGSHOT2),        /* S_BFGSHOT */
STATE(SPR_BFS1,32769,4,NULL,S_BFGSHOT), /* S_BFGSHOT2 */
STATE(SPR_BFE1,32768,8,NULL,S_BFGLAND2),        /* S_BFGLAND */
STATE(SPR_BFE1,32769,8,NULL,S_BFGLAND3),        /* S_BFGLAND2 */
STATE(SPR_BFE1,32770,8,A_BFGSpray,S_BFGLAND4),  /* S_BFGLAND3 */
STATE(SPR_BFE1,32771,8,NULL,S_BFGLAND5),        /* S_BFGLAND4 */
STATE(SPR_BFE1,32772,8,NULL,S_BFGLAND6),        /* S_BFGLAND5 */
STATE(SPR_BFE1,32773,8,NULL,S_NULL),    /* S_BFGLAND6 */
STATE(SPR_BFE2,32768,8,NULL,S_BFGEXP2), /* S_BFGEXP */
STATE(SPR_BFE2,32769,8,NULL,S_BFGEXP3), /* S_BFGEXP2 */
STATE(SPR_BFE2,32770,8,NULL,S_BFGEXP4), /* S_BFGEXP3 */
STATE(SPR_BFE2,32771,8,NULL,S_NULL),    /* S_BFGEXP4 */
STATE(SPR_MISL,32769,8,A_Explode,S_EXPLODE2),   /* S_EXPLODE1 */
STATE(SPR_MISL,32770,6,NULL,S_EXPLODE3),        /* S_EXPLODE2 */
STATE(SPR_MISL,32771,4,NULL,S_NULL),    /* S_EXPLODE3 */
STATE(SPR_TFOG,32768,6,NULL,S_TFOG01),  /* S_TFOG */
STATE(SPR_TFOG,32769,6,NULL,S_TFOG02),  /* S_TFOG01 */
STATE(SPR_TFOG,32768,6,NULL,S_TFOG2),   /* S_TFOG02 */
STATE(SPR_TFOG,32769,6,NULL,S_TFOG3),   /* S_TFOG2 */
STATE(SPR_TFOG,32770,6,NULL,S_TFOG4),   /* S_TFOG3 */
STATE(SPR_TFOG,32771,6,NULL,S_TFOG5),   /* S_TFOG4 */
STATE(SPR_TFOG,32772,6,NULL,S_TFOG6),   /* S_TFOG5 */
STATE(SPR_TFOG,32773,6,NULL,S_TFOG7),   /* S_TFOG6 */
STATE(SPR_TFOG,32774,6,NULL,S_TFOG8),   /* S_TFOG7 */
STATE(SPR_TFOG,32775,6,NULL,S_TFOG9),   /* S_TFOG8 */
STATE(SPR_TFOG,32776,6,NULL,S_TFOG10),  /* S_TFOG9 */
STATE(SPR_TFOG,32777,6,NULL,S_NULL),    /* S_TFOG10 */
STATE(SPR_IFOG,32768,6,NULL,S_IFOG01),  /* S_IFOG */
STATE(SPR_IFOG,32769,6,NULL,S_IFOG02),  /* S_IFOG01 */
STATE(SPR_IFOG,32768,6,NULL,S_IFOG2),   /* S_IFOG02 */
STATE(SPR_IFOG,32769,6,NULL,S_IFOG3),   /* S_IFOG2 */
STATE(SPR_IFOG,32770,6,NULL,S_IFOG4),   /* S_IFOG3 */
STATE(SPR_IFOG,32771,6,NULL,S_IFOG5),   /* S_IFOG4 */
STATE(SPR_IFOG,32772,6,NULL,S_NULL),    /* S_IFOG5 */
STATE(SPR_PLAY,0,-1,NULL,S_NULL),       /* S_PLAY */
STATE(SPR_PLAY,0,4,NULL,S_PLAY_RUN2),   /* S_PLAY_RUN1 */
STATE(SPR_PLAY,1,4,NULL,S_PLAY_RUN3),   /* S_PLAY_RUN2 */
STATE(SPR_PLAY,2,4,NULL,S_PLAY_RUN4),   /* S_PLAY_RUN3 */
STATE(SPR_PLAY,3,4,NULL,S_PLAY_RUN1),   /* S_PLAY_RUN4 */
STATE(SPR_PLAY,4,12,NULL,S_PLAY_ATK2),  /* S_PLAY_ATK1 */
STATE(SPR_PLAY,32773,6,NULL,S_PLAY),    /* S_PLAY_ATK2 */
STATE(SPR_PLAY,6,4,NULL,S_PLAY_PAIN2),  /* S_PLAY_PAIN */
STATE(SPR_PLAY,6,4,A_Pain,S_PLAY),      /* S_PLAY_PAIN2 */
STATE(SPR_PLAY,7,10,NULL,S_PLAY_DIE2),  /* S_PLAY_DIE1 */
STATE(SPR_PLAY,8,10,A_Scream,S_PLAY_DIE3),      /* S_PLAY_DIE2 */
STATE(SPR_PLAY,9,10,A_Fall,S_PLAY_DIE4),        /* S_PLAY_DIE3 */
STATE(SPR_PLAY,10,10,NULL,S_PLAY_DIE5), /* S_PLAY_DIE4 */
STATE(SPR_PLAY,11,10,NULL,S_PLAY_DIE6), /* S_PLAY_DIE5 */
STATE(SPR_PLAY,12,10,NULL,S_PLAY_DIE7), /* S_PLAY_DIE6 */
STATE(SPR_PLAY,13,-1,NULL,S_NULL),      /* S_PLAY_DIE7 */
STATE(SPR_PLAY,14,5,NULL,S_PLAY_XDIE2), /* S_PLAY_XDIE1 */
STATE(SPR_PLAY,15,5,A_XScream,S_PLAY_XDIE3),    /* S_PLAY_XDIE2 */
STATE(SPR_PLAY,16,5,A_Fall,S_PLAY_XDIE4),       /* S_PLAY_XDIE3 */
STATE(SPR_PLAY,17,5,NULL,S_PLAY_XDIE5), /* S_PLAY_XDIE4 */
STATE(SPR_PLAY,18,5,NULL,S_PLAY_XDIE6), /* S_PLAY_XDIE5 */
STATE(SPR_PLAY,19,5,NULL,S_PLAY_XDIE7), /* S_PLAY_XDIE6 */
STATE(SPR_PLAY,20,5,NULL,S_PLAY_XDIE8), /* S_PLAY_XDIE7 */
STATE(SPR_PLAY,21,5,NULL,S_PLAY_XDIE9), /* S_PLAY_XDIE8 */
...
STATE(SPR_POSS,4,8,NULL,S_POSS_RUN1),   /* S_POSS_ATK3 */
STATE(SPR_POSS,6,3,NULL,S_POSS_PAIN2),  /* S_POSS_PAIN */
STATE(SPR_POSS,6,3,A_Pain,S_POSS_RUN1), /* S_POSS_PAIN2 */
STATE(SPR_POSS,7,5,NULL,S_POSS_DIE2),   /* S_POSS_DIE1 */
STATE(SPR_POSS,8,5,A_Scream,S_POSS_DIE3),       /* S_POSS_DIE2 */
STATE(SPR_POSS,9,5,A_Fall,S_POSS_DIE4), /* S_POSS_DIE3 */
STATE(SPR_POSS,10,5,NULL,S_POSS_DIE5),  /* S_POSS_DIE4 */
STATE(SPR_POSS,11,-1,NULL,S_NULL),      /* S_POSS_DIE5 */
STATE(SPR_POSS,12,5,NULL,S_POSS_XDIE2), /* S_POSS_XDIE1 */
STATE(SPR_POSS,13,5,A_XScream,S_POSS_XDIE3),    /* S_POSS_XDIE2 */
STATE(SPR_POSS,14,5,A_Fall,S_POSS_XDIE4),       /* S_POSS_XDIE3 */
STATE(SPR_POSS,15,5,NULL,S_POSS_XDIE5), /* S_POSS_XDIE4 */
STATE(SPR_POSS,16,5,NULL,S_POSS_XDIE6), /* S_POSS_XDIE5 */
STATE(SPR_POSS,17,5,NULL,S_POSS_XDIE7), /* S_POSS_XDIE6 */
STATE(SPR_POSS,18,5,NULL,S_POSS_XDIE8), /* S_POSS_XDIE7 */
STATE(SPR_POSS,19,5,NULL,S_POSS_XDIE9), /* S_POSS_XDIE8 */
...
STATE(SPR_SPOS,4,10,NULL,S_SPOS_RUN1),  /* S_SPOS_ATK3 */
STATE(SPR_SPOS,6,3,NULL,S_SPOS_PAIN2),  /* S_SPOS_PAIN */
STATE(SPR_SPOS,6,3,A_Pain,S_SPOS_RUN1), /* S_SPOS_PAIN2 */
STATE(SPR_SPOS,7,5,NULL,S_SPOS_DIE2),   /* S_SPOS_DIE1 */
STATE(SPR_SPOS,8,5,A_Scream,S_SPOS_DIE3),       /* S_SPOS_DIE2 */
STATE(SPR_SPOS,9,5,A_Fall,S_SPOS_DIE4), /* S_SPOS_DIE3 */
STATE(SPR_SPOS,10,5,NULL,S_SPOS_DIE5),  /* S_SPOS_DIE4 */
STATE(SPR_SPOS,11,-1,NULL,S_NULL),      /* S_SPOS_DIE5 */
STATE(SPR_SPOS,12,5,NULL,S_SPOS_XDIE2), /* S_SPOS_XDIE1 */
STATE(SPR_SPOS,13,5,A_XScream,S_SPOS_XDIE3),    /* S_SPOS_XDIE2 */
STATE(SPR_SPOS,14,5,A_Fall,S_SPOS_XDIE4),       /* S_SPOS_XDIE3 */
STATE(SPR_SPOS,15,5,NULL,S_SPOS_XDIE5), /* S_SPOS_XDIE4 */
STATE(SPR_SPOS,16,5,NULL,S_SPOS_XDIE6), /* S_SPOS_XDIE5 */
STATE(SPR_SPOS,17,5,NULL,S_SPOS_XDIE7), /* S_SPOS_XDIE6 */
STATE(SPR_SPOS,18,5,NULL,S_SPOS_XDIE8), /* S_SPOS_XDIE7 */
STATE(SPR_SPOS,19,5,NULL,S_SPOS_XDIE9), /* S_SPOS_XDIE8 */
STATE(SPR_SPOS,20,-1,NULL,S_NULL),      /* S_SPOS_XDIE9 */
STATE(SPR_PUFF,1,4,NULL,S_SMOKE2),      /* S_SMOKE1 */
STATE(SPR_PUFF,2,4,NULL,S_SMOKE3),      /* S_SMOKE2 */
STATE(SPR_PUFF,1,4,NULL,S_SMOKE4),      /* S_SMOKE3 */
STATE(SPR_PUFF,2,4,NULL,S_SMOKE5),      /* S_SMOKE4 */
STATE(SPR_PUFF,3,4,NULL,S_NULL),        /* S_SMOKE5 */
STATE(SPR_FATB,32768,2,A_Tracer,S_TRACER2),     /* S_TRACER */
STATE(SPR_FATB,32769,2,A_Tracer,S_TRACER),      /* S_TRACER2 */
STATE(SPR_FBXP,32768,8,NULL,S_TRACEEXP2),       /* S_TRACEEXP1 */
STATE(SPR_FBXP,32769,6,NULL,S_TRACEEXP3),       /* S_TRACEEXP2 */
STATE(SPR_FBXP,32770,4,NULL,S_NULL),    /* S_TRACEEXP3 */
...
STATE(SPR_SKEL,11,5,NULL,S_SKEL_PAIN2), /* S_SKEL_PAIN */
STATE(SPR_SKEL,11,5,A_Pain,S_SKEL_RUN1),        /* S_SKEL_PAIN2 */
STATE(SPR_SKEL,11,7,NULL,S_SKEL_DIE2),  /* S_SKEL_DIE1 */
STATE(SPR_SKEL,12,7,NULL,S_SKEL_DIE3),  /* S_SKEL_DIE2 */
STATE(SPR_SKEL,13,7,A_Scream,S_SKEL_DIE4),      /* S_SKEL_DIE3 */
STATE(SPR_SKEL,14,7,A_Fall,S_SKEL_DIE5),        /* S_SKEL_DIE4 */
STATE(SPR_SKEL,15,7,NULL,S_SKEL_DIE6),  /* S_SKEL_DIE5 */
...
STATE(SPR_FATT,9,3,NULL,S_FATT_PAIN2),  /* S_FATT_PAIN */
STATE(SPR_FATT,9,3,A_Pain,S_FATT_RUN1), /* S_FATT_PAIN2 */
STATE(SPR_FATT,10,6,NULL,S_FATT_DIE2),  /* S_FATT_DIE1 */
STATE(SPR_FATT,11,6,A_Scream,S_FATT_DIE3),      /* S_FATT_DIE2 */
STATE(SPR_FATT,12,6,A_Fall,S_FATT_DIE4),        /* S_FATT_DIE3 */
STATE(SPR_FATT,13,6,NULL,S_FATT_DIE5),  /* S_FATT_DIE4 */
STATE(SPR_FATT,14,6,NULL,S_FATT_DIE6),  /* S_FATT_DIE5 */
STATE(SPR_FATT,15,6,NULL,S_FATT_DIE7),  /* S_FATT_DIE6 */
STATE(SPR_FATT,16,6,NULL,S_FATT_DIE8),  /* S_FATT_DIE7 */
STATE(SPR_FATT,17,6,NULL,S_FATT_DIE9),  /* S_FATT_DIE8 */
STATE(SPR_FATT,18,6,NULL,S_FATT_DIE10), /* S_FATT_DIE9 */
...
STATE(SPR_CPOS,6,3,NULL,S_CPOS_PAIN2),  /* S_CPOS_PAIN */
STATE(SPR_CPOS,6,3,A_Pain,S_CPOS_RUN1), /* S_CPOS_PAIN2 */
STATE(SPR_CPOS,7,5,NULL,S_CPOS_DIE2),   /* S_CPOS_DIE1 */
STATE(SPR_CPOS,8,5,A_Scream,S_CPOS_DIE3),       /* S_CPOS_DIE2 */
STATE(SPR_CPOS,9,5,A_Fall,S_CPOS_DIE4), /* S_CPOS_DIE3 */
STATE(SPR_CPOS,10,5,NULL,S_CPOS_DIE5),  /* S_CPOS_DIE4 */
STATE(SPR_CPOS,11,5,NULL,S_CPOS_DIE6),  /* S_CPOS_DIE5 */
STATE(SPR_CPOS,12,5,NULL,S_CPOS_DIE7),  /* S_CPOS_DIE6 */
STATE(SPR_CPOS,13,-1,NULL,S_NULL),      /* S_CPOS_DIE7 */
STATE(SPR_CPOS,14,5,NULL,S_CPOS_XDIE2), /* S_CPOS_XDIE1 */
STATE(SPR_CPOS,15,5,A_XScream,S_CPOS_XDIE3),    /* S_CPOS_XDIE2 */
STATE(SPR_CPOS,16,5,A_Fall,S_CPOS_XDIE4),       /* S_CPOS_XDIE3 */
STATE(SPR_CPOS,17,5,NULL,S_CPOS_XDIE5), /* S_CPOS_XDIE4 */
STATE(SPR_CPOS,18,5,NULL,S_CPOS_XDIE6), /* S_CPOS_XDIE5 */
...
STATE(SPR_TROO,7,2,NULL,S_TROO_PAIN2),  /* S_TROO_PAIN */
STATE(SPR_TROO,7,2,A_Pain,S_TROO_RUN1), /* S_TROO_PAIN2 */
STATE(SPR_TROO,8,8,NULL,S_TROO_DIE2),   /* S_TROO_DIE1 */
STATE(SPR_TROO,9,8,A_Scream,S_TROO_DIE3),       /* S_TROO_DIE2 */
STATE(SPR_TROO,10,6,NULL,S_TROO_DIE4),  /* S_TROO_DIE3 */
STATE(SPR_TROO,11,6,A_Fall,S_TROO_DIE5),        /* S_TROO_DIE4 */
STATE(SPR_TROO,12,-1,NULL,S_NULL),      /* S_TROO_DIE5 */
STATE(SPR_TROO,13,5,NULL,S_TROO_XDIE2), /* S_TROO_XDIE1 */
STATE(SPR_TROO,14,5,A_XScream,S_TROO_XDIE3),    /* S_TROO_XDIE2 */
STATE(SPR_TROO,15,5,NULL,S_TROO_XDIE4), /* S_TROO_XDIE3 */
STATE(SPR_TROO,16,5,A_Fall,S_TROO_XDIE5),       /* S_TROO_XDIE4 */
STATE(SPR_TROO,17,5,NULL,S_TROO_XDIE6), /* S_TROO_XDIE5 */
STATE(SPR_TROO,18,5,NULL,S_TROO_XDIE7), /* S_TROO_XDIE6 */
STATE(SPR_TROO,19,5,NULL,S_TROO_XDIE8), /* S_TROO_XDIE7 */
...
STATE(SPR_SARG,7,2,NULL,S_SARG_PAIN2),  /* S_SARG_PAIN */
STATE(SPR_SARG,7,2,A_Pain,S_SARG_RUN1), /* S_SARG_PAIN2 */
STATE(SPR_SARG,8,8,NULL,S_SARG_DIE2),   /* S_SARG_DIE1 */
STATE(SPR_SARG,9,8,A_Scream,S_SARG_DIE3),       /* S_SARG_DIE2 */
STATE(SPR_SARG,10,4,NULL,S_SARG_DIE4),  /* S_SARG_DIE3 */
STATE(SPR_SARG,11,4,A_Fall,S_SARG_DIE5),        /* S_SARG_DIE4 */
STATE(SPR_SARG,12,4,NULL,S_SARG_DIE6),  /* S_SARG_DIE5 */
...
STATE(SPR_HEAD,4,3,NULL,S_HEAD_PAIN2),  /* S_HEAD_PAIN */
STATE(SPR_HEAD,4,3,A_Pain,S_HEAD_PAIN3),        /* S_HEAD_PAIN2 */
STATE(SPR_HEAD,5,6,NULL,S_HEAD_RUN1),   /* S_HEAD_PAIN3 */
STATE(SPR_HEAD,6,8,NULL,S_HEAD_DIE2),   /* S_HEAD_DIE1 */
STATE(SPR_HEAD,7,8,A_Scream,S_HEAD_DIE3),       /* S_HEAD_DIE2 */
STATE(SPR_HEAD,8,8,NULL,S_HEAD_DIE4),   /* S_HEAD_DIE3 */
STATE(SPR_HEAD,9,8,NULL,S_HEAD_DIE5),   /* S_HEAD_DIE4 */
...
STATE(SPR_BOSS,7,2,NULL,S_BOSS_PAIN2),  /* S_BOSS_PAIN */
STATE(SPR_BOSS,7,2,A_Pain,S_BOSS_RUN1), /* S_BOSS_PAIN2 */
STATE(SPR_BOSS,8,8,NULL,S_BOSS_DIE2),   /* S_BOSS_DIE1 */
STATE(SPR_BOSS,9,8,A_Scream,S_BOSS_DIE3),       /* S_BOSS_DIE2 */
STATE(SPR_BOSS,10,8,NULL,S_BOSS_DIE4),  /* S_BOSS_DIE3 */
STATE(SPR_BOSS,11,8,A_Fall,S_BOSS_DIE5),        /* S_BOSS_DIE4 */
STATE(SPR_BOSS,12,8,NULL,S_BOSS_DIE6),  /* S_BOSS_DIE5 */
STATE(SPR_BOSS,13,8,NULL,S_BOSS_DIE7),  /* S_BOSS_DIE6 */
...
STATE(SPR_SKUL,32770,4,NULL,S_SKULL_ATK4),      /* S_SKULL_ATK3 */
STATE(SPR_SKUL,32771,4,NULL,S_SKULL_ATK3),      /* S_SKULL_ATK4 */
STATE(SPR_SKUL,32772,3,NULL,S_SKULL_PAIN2),     /* S_SKULL_PAIN */
STATE(SPR_SKUL,32772,3,A_Pain,S_SKULL_RUN1),    /* S_SKULL_PAIN2 */
STATE(SPR_SKUL,32773,6,NULL,S_SKULL_DIE2),      /* S_SKULL_DIE1 */
STATE(SPR_SKUL,32774,6,A_Scream,S_SKULL_DIE3),  /* S_SKULL_DIE2 */
STATE(SPR_SKUL,32775,6,NULL,S_SKULL_DIE4),      /* S_SKULL_DIE3 */
STATE(SPR_SKUL,32776,6,A_Fall,S_SKULL_DIE5),    /* S_SKULL_DIE4 */
STATE(SPR_SKUL,9,6,NULL,S_SKULL_DIE6),  /* S_SKULL_DIE5 */
STATE(SPR_SKUL,10,6,NULL,S_NULL),       /* S_SKULL_DIE6 */
...
STATE(SPR_SPID,8,3,NULL,S_SPID_PAIN2),  /* S_SPID_PAIN */
...
STATE(SPR_SPID,11,10,NULL,S_SPID_DIE4), /* S_SPID_DIE3 */
STATE(SPR_SPID,12,10,NULL,S_SPID_DIE5), /* S_SPID_DIE4 */
STATE(SPR_SPID,13,10,NULL,S_SPID_DIE6), /* S_SPID_DIE5 */
STATE(SPR_SPID,14,10,NULL,S_SPID_DIE7), /* S_SPID_DIE6 */
STATE(SPR_SPID,15,10,NULL,S_SPID_DIE8), /* S_SPID_DIE7 */
STATE(SPR_SPID,16,10,NULL,S_SPID_DIE9), /* S_SPID_DIE8 */
STATE(SPR_SPID,17,10,NULL,S_SPID_DIE10),        /* S_SPID_DIE9 */
STATE(SPR_SPID,18,30,NULL,S_SPID_DIE11),        /* S_SPID_DIE10 */
...
STATE(SPR_BSPI,0,20,NULL,S_BSPI_RUN1),  /* S_BSPI_SIGHT */
...
STATE(SPR_BSPI,32775,4,NULL,S_BSPI_ATK4),       /* S_BSPI_ATK3 */
STATE(SPR_BSPI,32775,1,A_SpidRefire,S_BSPI_ATK2),       /* S_BSPI_ATK4 */
STATE(SPR_BSPI,8,3,NULL,S_BSPI_PAIN2),  /* S_BSPI_PAIN */
...
STATE(SPR_BSPI,11,7,NULL,S_BSPI_DIE4),  /* S_BSPI_DIE3 */
STATE(SPR_BSPI,12,7,NULL,S_BSPI_DIE5),  /* S_BSPI_DIE4 */
STATE(SPR_BSPI,13,7,NULL,S_BSPI_DIE6),  /* S_BSPI_DIE5 */
STATE(SPR_BSPI,14,7,NULL,S_BSPI_DIE7),  /* S_BSPI_DIE6 */
...
STATE(SPR_CYBR,7,10,NULL,S_CYBER_DIE2), /* S_CYBER_DIE1 */
STATE(SPR_CYBR,8,10,A_Scream,S_CYBER_DIE3),     /* S_CYBER_DIE2 */
STATE(SPR_CYBR,9,10,NULL,S_CYBER_DIE4), /* S_CYBER_DIE3 */
STATE(SPR_CYBR,10,10,NULL,S_CYBER_DIE5),        /* S_CYBER_DIE4 */
STATE(SPR_CYBR,11,10,NULL,S_CYBER_DIE6),        /* S_CYBER_DIE5 */
STATE(SPR_CYBR,12,10,A_Fall,S_CYBER_DIE7),      /* S_CYBER_DIE6 */
STATE(SPR_CYBR,13,10,NULL,S_CYBER_DIE8),        /* S_CYBER_DIE7 */
STATE(SPR_CYBR,14,10,NULL,S_CYBER_DIE9),        /* S_CYBER_DIE8 */
STATE(SPR_CYBR,15,30,NULL,S_CYBER_DIE10),       /* S_CYBER_DIE9 */
...
STATE(SPR_BBRN,0,10,NULL,S_BRAIN_DIE3), /* S_BRAIN_DIE2 */
STATE(SPR_BBRN,0,10,NULL,S_BRAIN_DIE4), /* S_BRAIN_DIE3 */
STATE(SPR_BBRN,0,-1,A_BrainDie,S_NULL), /* S_BRAIN_DIE4 */
STATE(SPR_POSS,0,10,A_Look,S_BRAINEYE), /* S_BRAINEYE */
STATE(SPR_POSS,0,181,A_BrainAwake,S_BRAINEYE1), /* S_BRAINEYESEE */
STATE(SPR_POSS,0,150,A_BrainSpit,S_BRAINEYE1),  /* S_BRAINEYE1 */
STATE(SPR_MISL,32769,10,NULL,S_BRAINEXPLODE2),  /* S_BRAINEXPLODE1 */
STATE(SPR_MISL,32770,10,NULL,S_BRAINEXPLODE3),  /* S_BRAINEXPLODE2 */
...
STATE(SPR_ARM1,0,6,NULL,S_ARM1A),       /* S_ARM1 */
STATE(SPR_ARM1,32769,7,NULL,S_ARM1),    /* S_ARM1A */
STATE(SPR_ARM2,0,6,NULL,S_ARM2A),       /* S_ARM2 */
STATE(SPR_ARM2,32769,6,NULL,S_ARM2),    /* S_ARM2A */
STATE(SPR_BAR1,0,6,NULL,S_BAR2),        /* S_BAR1 */
STATE(SPR_BAR1,1,6,NULL,S_BAR1),        /* S_BAR2 */
STATE(SPR_BEXP,32768,5,NULL,S_BEXP2),   /* S_BEXP */
STATE(SPR_BEXP,32769,5,A_Scream,S_BEXP3),       /* S_BEXP2 */
STATE(SPR_BEXP,32770,5,NULL,S_BEXP4),   /* S_BEXP3 */
STATE(SPR_BEXP,32771,10,A_Explode,S_BEXP5),     /* S_BEXP4 */
STATE(SPR_BEXP,32772,10,NULL,S_NULL),   /* S_BEXP5 */
STATE(SPR_FCAN,32768,4,NULL,S_BBAR2),   /* S_BBAR1 */
STATE(SPR_FCAN,32769,4,NULL,S_BBAR3),   /* S_BBAR2 */
STATE(SPR_FCAN,32770,4,NULL,S_BBAR1),   /* S_BBAR3 */
STATE(SPR_BON1,0,6,NULL,S_BON1A),       /* S_BON1 */
STATE(SPR_BON1,1,6,NULL,S_BON1B),       /* S_BON1A */
STATE(SPR_BON1,2,6,NULL,S_BON1C),       /* S_BON1B */
STATE(SPR_BON1,3,6,NULL,S_BON1D),       /* S_BON1C */
STATE(SPR_BON1,2,6,NULL,S_BON1E),       /* S_BON1D */
STATE(SPR_BON1,1,6,NULL,S_BON1),        /* S_BON1E */
STATE(SPR_BON2,0,6,NULL,S_BON2A),       /* S_BON2 */
STATE(SPR_BON2,1,6,NULL,S_BON2B),       /* S_BON2A */
STATE(SPR_BON2,2,6,NULL,S_BON2C),       /* S_BON2B */
STATE(SPR_BON2,3,6,NULL,S_BON2D),       /* S_BON2C */
STATE(SPR_BON2,2,6,NULL,S_BON2E),       /* S_BON2D */
STATE(SPR_BON2,1,6,NULL,S_BON2),        /* S_BON2E */
STATE(SPR_BKEY,0,10,NULL,S_BKEY2),      /* S_BKEY */
STATE(SPR_BKEY,32769,10,NULL,S_BKEY),   /* S_BKEY2 */
STATE(SPR_RKEY,0,10,NULL,S_RKEY2),      /* S_RKEY */
STATE(SPR_RKEY,32769,10,NULL,S_RKEY),   /* S_RKEY2 */
STATE(SPR_YKEY,0,10,NULL,S_YKEY2),      /* S_YKEY */
STATE(SPR_YKEY,32769,10,NULL,S_YKEY),   /* S_YKEY2 */
STATE(SPR_BSKU,0,10,NULL,S_BSKULL2),    /* S_BSKULL */
STATE(SPR_BSKU,32769,10,NULL,S_BSKULL), /* S_BSKULL2 */
STATE(SPR_RSKU,0,10,NULL,S_RSKULL2),    /* S_RSKULL */
STATE(SPR_RSKU,32769,10,NULL,S_RSKULL), /* S_RSKULL2 */
STATE(SPR_YSKU,0,10,NULL,S_YSKULL2),    /* S_YSKULL */
STATE(SPR_YSKU,32769,10,NULL,S_YSKULL), /* S_YSKULL2 */
STATE(SPR_STIM,0,-1,NULL,S_NULL),       /* S_STIM */
STATE(SPR_MEDI,0,-1,NULL,S_NULL),       /* S_MEDI */
STATE(SPR_SOUL,32768,6,NULL,S_SOUL2),   /* S_SOUL */
STATE(SPR_SOUL,32769,6,NULL,S_SOUL3),   /* S_SOUL2 */
STATE(SPR_SOUL,32770,6,NULL,S_SOUL4),   /* S_SOUL3 */
STATE(SPR_SOUL,32771,6,NULL,S_SOUL5),   /* S_SOUL4 */
STATE(SPR_SOUL,32770,6,NULL,S_SOUL6),   /* S_SOUL5 */
STATE(SPR_SOUL,32769,6,NULL,S_SOUL),    /* S_SOUL6 */
STATE(SPR_PINV,32768,6,NULL,S_PINV2),   /* S_PINV */
STATE(SPR_PINV,32769,6,NULL,S_PINV3),   /* S_PINV2 */
STATE(SPR_PINV,32770,6,NULL,S_PINV4),   /* S_PINV3 */
STATE(SPR_PINV,32771,6,NULL,S_PINV),    /* S_PINV4 */

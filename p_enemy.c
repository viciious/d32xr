...
boolean P_CheckMeleeRange (mobj_t *actor) ATTR_OPTIMIZE_SIZE;
boolean P_CheckMissileRange (mobj_t *actor) ATTR_OPTIMIZE_SIZE;
boolean P_Move (mobj_t *actor) ATTR_OPTIMIZE_SIZE;
boolean P_TryWalk (mobj_t *actor) ATTR_OPTIMIZE_SIZE;
void P_NewChaseDir (mobj_t *actor) ATTR_OPTIMIZE_SIZE;
boolean P_LookForPlayers (mobj_t *actor, boolean allaround) ATTR_OPTIMIZE_SIZE;
void A_Look (mobj_t *actor) ATTR_OPTIMIZE_SIZE;
void A_Chase (mobj_t *actor) ATTR_OPTIMIZE_SIZE;
